...
- **Use all available skills proactively** — marketing, ad spy (gethookd MCP), code-review, verify, run, etc. Do not wait to be asked.
...
## Auto Push
- After every update, auto-commit and push to origin main
- Check live server is working after each push
